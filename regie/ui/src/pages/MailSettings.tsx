    ...
    <div className="settings">
      <form className="settings-col" onSubmit={onSubmit}>
        ...
        <section className="settings-card">
          ...
          <p className="settings-meta">
            <a className="settings-link" href={data?.feed_md || "/api/v1/mail/feed.md"} target="_blank" rel="noreferrer">
              {data?.feed_md || "/api/v1/mail/feed.md"}
            </a>
            {" · "}
            <a className="settings-link" href={data?.feed_atom || "/api/v1/mail/feed.atom"} target="_blank" rel="noreferrer">
              {data?.feed_atom || "/api/v1/mail/feed.atom"}
            </a>
          </p>
          <code className="settings-code">
            {`mkdir -p ~/Documents/RadioCampus/file-cowork && curl -o ~/Documents/RadioCampus/file-cowork/file.md -H 'Authorization: Bearer …' 'http://nasgul.taild4714f.ts.net:30130${data?.feed_md || "/api/v1/mail/feed.md"}'`}
          </code>
        </section>
